    ...
    build: {
      ...
      rolldownOptions: {
        ...
        output: {
          // 拆包
          codeSplitting: [
            // 原有配置 (已修正正则语法，将 [] 改为 () 分组)
            { name: "vue-chunks", test: /node_modules\/(vue|vue-router|pinia|vue-i18n)/ },
            { name: "element-plus", test: /node_modules\/element-plus/ },
            { name: "wang-editor", test: /node_modules\/(@wangeditor\/editor|@wangeditor\/editor-for-vue)/ },
            { name: "tinymce", test: /node_modules\/(tinymce|@tinymce\/tinymce-vue)/ },
            { name: "echarts", test: /node_modules\/echarts/ },
            {
              name: "codemirror",
              test: /node_modules\/(codemirror|@codemirror\/commands|@codemirror\/language|@codemirror\/lint|@codemirror\/state|@codemirror\/view)/,
            },
            {
              name: "codemirror-lang",
              test: /node_modules\/(@codemirror\/lang-html|@codemirror\/lang-javascript|@codemirror\/lang-markdown|@codemirror\/lang-java|@codemirror\/lang-json|@codemirror\/lang-php|@codemirror\/lang-python|@codemirror\/lang-sql|@codemirror\/lang-xml)/,
            },
            {
              name: "codemirror-theme",
              test: /node_modules\/(@codemirror\/theme-one-dark|@uiw\/codemirror-theme-dracula|@uiw\/codemirror-theme-xcode)/,
            },
          ],
