...
export default {
  ...
  _setting: {
    ...
    headerMenuAlign: "顶栏菜单位置",
    tabNavHeight: "标签栏高度",
    themePanelTriggerPosition: {
      label: "主题面板触发位置",
      header: "顶栏",
      fixed: "固定",
    },
    ...
    radius: "圆角大小",
    watermark: "全局水印",
    showProgress: "页面切换显示进度条",
    breadcrumbHideOnlyOne: "仅有一个时隐藏",
    breadcrumbShowHome: "显示首页",
    breadcrumbOnlyShowHomeIcon: "仅显示首页按钮",
    tabNavDraggable: "启动拖拽排序",
    tabNavMiddleClickToClose: "点击鼠标中键关闭标签页",
    tabNavMiddleClickToOpen: "点击鼠标中键打开标签页",
    tabNavShowMore: "显示更多按钮",
    tabNavWheel: "启用纵向滚轮响应",
