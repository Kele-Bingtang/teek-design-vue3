...
export default {
  ...
  _setting: {
    ...
    headerMenuAlign: "Header Menu Align",
    tabNavHeight: "Tab Nav Height",
    ...
    showLogo: "Show The Side Menu Logo",
    ...
    breadcrumbHideOnlyOne: "Breadcrumb Hide Only One",
    breadcrumbShowHome: "Breadcrumb Show Home",
    breadcrumbOnlyShowHomeIcon: "Breadcrumb Only Show Home Icon",
    tabNavDraggable: "TabNav Draggable",
    tabNavMiddleClickToClose: "TabNav Middle Click To Close",
    tabNavMiddleClickToOpen: "TabNav Middle Click To Open",
    tabNavShowMore: "TabNav Show More",
    tabNavWheel: "TabNav Wheel",
