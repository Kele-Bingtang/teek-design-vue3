...
const presetBanners = {
  ...
  info: {
    ...
    buttonConfig: {
      show: true,
      text: "立即续费",
      color: `rgb(${ns.cssVar("color-secondary-rgb")}, 0.9)`,
      textColor: "#fff",
    },
  },
} as const;
