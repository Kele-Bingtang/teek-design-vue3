...
const statsCards = [
  {
    ...
    icon: "&#xe812;",
    iconColor: `rgb(${ns.cssVar("primary")})`,
    iconSize: 20,
    iconBgColor: `rgb(${ns.cssVar("info")})`,
    textColor: `rgb(${ns.cssVar("primary")})`,
    backgroundColor: `rgb(${ns.cssVar("bg-primary")})`,
    showArrow: false,
  },
  {
    id: 2,
    ...
    icon: "&#xe724;",
    iconColor: `rgb(${ns.cssVar("warning")})`,
    iconSize: 20,
    iconBgColor: `rgb(${ns.cssVar("success")})`,
    textColor: `rgb(${ns.cssVar("warning")})`,
    backgroundColor: `rgb(${ns.cssVar("bg-warning")})`,
    showArrow: false,
  },
  {
    id: 3,
    ...
    icon: "&#xe70e;",
    iconColor: `rgb(${ns.cssVar("secondary")})`,
    iconSize: 20,
    iconBgColor: `rgb(${ns.cssVar("secondary")})`,
    textColor: `rgb(${ns.cssVar("secondary")})`,
    backgroundColor: `rgb(${ns.cssVar("bg-secondary")})`,
    showArrow: false,
  },
  {
    id: 4,
    ...
    icon: "&#xe82d;",
    iconColor: `rgb(${ns.cssVar("error")})`,
    iconSize: 20,
    iconBgColor: `rgb(${ns.cssVar("error")})`,
    textColor: `rgb(${ns.cssVar("error")})`,
    backgroundColor: `rgb(${ns.cssVar("bg-error")})`,
    showArrow: false,
  },
];
...
const progressCards = [
  {
    ...
    icon: "&#xe812;",
    iconColor: `rgb(${ns.cssVar("success")})`,
    iconBgColor: `rgb(${ns.cssVar("bg-success")})`,
    iconSize: 20,
  },
  {
    id: 2,
    ...
    icon: "&#xe724;",
    iconColor: `rgb(${ns.cssVar("primary")})`,
    iconBgColor: `rgb(${ns.cssVar("bg-primary")})`,
    iconSize: 20,
  },
  {
    id: 3,
    ...
    icon: "&#xe724;",
    iconColor: `rgb(${ns.cssVar("error")})`,
    iconBgColor: `rgb(${ns.cssVar("bg-error")})`,
    iconSize: 20,
  },
  {
    id: 4,
    title: "任务进度",
    percentage: 90,
    color: `rgb(${ns.cssVar("secondary")})`,
    icon: "&#xe724;",
    iconColor: `rgb(${ns.cssVar("secondary")})`,
    iconBgColor: `rgb(${ns.cssVar("bg-secondary")})`,
    iconSize: 20,
  },
];
